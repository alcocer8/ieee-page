export const speakers = [
  {
    name: "Dr. Ignacio Enrique Zaldívar Huerta",
    pos: [
      "- National Researcher Level 1",
      "- IEEE Senior Member",
      "- IEEE Section Puebla Chair",
    ],
  ...
  },
  {
    ...
    pos: [
      "- Master's Degree in Chemistry and Doctorate in Sciences from the Autonomous Metropolitan University",
      "- National Researcher Level 1",
    ],
  ...
  },
  {
    ...
    pos: [
      "- Doctoral in Computer Science at the University of Chile Faculty of Physical and Mathematical Sciences",
  ...
  },
  {
    ...
    pos: [
      "- Doctor en Ciencias Quimicas (Corrosíon, Mecanica de Fractura) UNAM, IPN",
  ...
  },
  {
    ...
    pos: [
      "- Coordinadora de la Academia de Mecánica, area Mecánica Eléctrica",
      "- Miembro del Cuerpo Académico de Termofluidos y Energía",
      "- Universidad Veracruzana",
    ],
